...
if __name__ == '__main__':
	...
	"""proyecto_data = {
      		"name": "TEST1",
        	"sg_type": "Other",
        	"sg_description": "Test 1 prueba de shots, secuencias y tareas.",
        	"tank_name": "test1",
    	}
	...
	tarea1_data = {
		'project': {'type':'Project', 'id':test1['id']},
		'content': 'Modelar',
	...
	#CREANDO SECUENCIA
	sequence = sg.create("Sequence", {"project": test1, "code": "seq0001"})
	sequence

	#BUSQUEDA DE SHOTS
	shots = sg.find("Shot", [["project", "is", test1]])
